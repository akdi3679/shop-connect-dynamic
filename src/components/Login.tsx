...
import { LogIn, Store, UserPlus, Eye, EyeOff, Sparkles } from 'lucide-react';
            ...
            <Form {...guestForm}>
              <form onSubmit={guestForm.handleSubmit(onGuestSubmit)} className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-black font-semibold">Store Name</FormLabel>
                      <FormControl>
                        <Input 
        ...
        <CardContent className="space-y-6">
          <Form {...loginForm}>
            <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-6">
              ...
              <Button 
                type="submit" 
                className="w-full h-12 bg-black hover:bg-gray-800 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 font-semibold"
              >
          ...
          <div className="space-y-4">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 rounded-xl border-gray-300 hover:bg-gray-50 transition-all duration-200"
            ...
            <Button
              type="button"
              variant="ghost"
              className="w-full h-12 rounded-xl hover:bg-gray-50 transition-all duration-200 text-black"
          ...
          <div className="p-4 bg-gray-50 border border-gray-200 rounded-xl">
            <p className="text-xs text-black/60 flex items-center">
